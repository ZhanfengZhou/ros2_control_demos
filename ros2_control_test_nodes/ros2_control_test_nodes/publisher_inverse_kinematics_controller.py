...
class PublisherJointTrajectory(Node):
    ...
    def inverse_kinematics(self, goals_value):
        ...
        if input_goals_ok :
            ...
            desired_joints_configs = [float(angle) for angle in [0, -90, -60, -120, 90, -90]]
            ...
            joints_limits['elbow_joint'] = [math.radians(r) for r in [float(angle) for angle in [-150,0+1]] ] 
            joints_limits['wrist_1_joint'] = [math.radians(r) for r in [float(angle) for angle in [-160, 100]] ] 
            joints_limits['wrist_2_joint'] = [math.radians(r) for r in [float(angle) for angle in [-150, 150]] ] 
            joints_limits['wrist_3_joint'] = [math.radians(r) for r in [float(angle) for angle in [-180, 180]] ] 
